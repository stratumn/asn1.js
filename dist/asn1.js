(function (global, factory) {
	...
	(factory((global.asn1 = global.asn1 || {}, global.asn1.js = {})));
	...
	*/
	...
	inherits_browser(DecoderBuffer, Reporter);
	...
	inherits_browser(PEMEncoder, DEREncoder);
	...
	inherits_browser(PEMDecoder, DERDecoder);
	...
	Entity.prototype._createNamed = function createNamed(base) {
	  var named = void 0;
	  try {
	    named = runInThisContext('(function ' + this.name + '(entity) {\n' + '  this._initNamed(entity);\n' + '})');
	  } catch (e) {
